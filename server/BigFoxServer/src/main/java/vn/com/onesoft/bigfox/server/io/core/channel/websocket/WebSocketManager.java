...
//            X509Certificate certRoot = (X509Certificate) cf.generateCertificate(new FileInputStream("G:\\Bitbucket\\livetube-server\\ssl\\STAR_vivulive_com\\AddTrustExternalCARoot.crt"));
//            X509Certificate certStar = (X509Certificate) cf.generateCertificate(new FileInputStream("G:\\Bitbucket\\livetube-server\\ssl\\STAR_vivulive_com\\STAR_vivulive_com.crt"));
//            X509Certificate certStrust = (X509Certificate) cf.generateCertificate(new FileInputStream("G:\\Bitbucket\\livetube-server\\ssl\\STAR_vivulive_com\\COMODORSAAddTrustCA.crt"));
//            X509Certificate certDomain = (X509Certificate) cf.generateCertificate(new FileInputStream("G:\\Bitbucket\\livetube-server\\ssl\\STAR_vivulive_com\\COMODORSADomainValidationSecureServerCA.crt"));
